...
"""
FastAPI application for the Storemanager Environment.

This module creates an HTTP server that exposes the StoremanagerEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    multiple workers:
        uvicorn StoreManager.server.app:app --workers 4
    """
    import uvicorn
